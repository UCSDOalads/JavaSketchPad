...
public class FieldsPaintComponent extends DataTextIOPaintComponent implements DataFromPointDataProvider{
	...
	public FieldsPaintComponent(Class displayingClass, Object instance, int x, int y) {
	...
	public void evaluate(DataFromPoint dataFromPoint){
		...
		try {
			returnVal = field.get(operatingInstance);
	 ...
	 * @param dataFromPoint
	 * @return true if there is, flase if not.
	 */
	@Override
	...
	/**
	 * Check whether there's information to retrieve
	 * @param dataFromPoint
